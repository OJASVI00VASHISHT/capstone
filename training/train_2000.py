...
def main():
    print("=" * 60)
    print("Starting Mask R-CNN Training on Unified 2000-Image Dataset")
    print("=" * 60)

    # Previous paths (preserved as comments):
    ...
    # Unified 2000-Image Dataset paths:
    json_path = "images2000.json"
    image_dir = "images2000"
    output_model_path = "mask_rcnn_model_2000.pth"
